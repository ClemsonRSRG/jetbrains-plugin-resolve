...
import edu.clemson.resolve.plugin.psi.impl.ResPrecisModuleDeclImpl;
...
public class RESOLVEASTFactory extends ASTFactory {
    ...
    static {
        ...
        ruleElementTypeToPsiFactory.put(RESOLVETokenTypes.RULE_ELEMENT_TYPES.get(Resolve.RULE_precisExtensionModuleDecl), ResPrecisExtensionModuleDeclImpl.Factory.INSTANCE);
        ruleElementTypeToPsiFactory.put(RESOLVETokenTypes.RULE_ELEMENT_TYPES.get(Resolve.RULE_precisBlock), ResBlockImpl.Factory.INSTANCE);
        ...
        ruleElementTypeToPsiFactory.put(RESOLVETokenTypes.RULE_ELEMENT_TYPES.get(Resolve.RULE_mathInfixDefinitionSig), ResMathDefSigImpl.Factory.INSTANCE);
        ruleElementTypeToPsiFactory.put(RESOLVETokenTypes.RULE_ELEMENT_TYPES.get(Resolve.RULE_mathPrefixDefinitionSig), ResMathDefSigImpl.Factory.INSTANCE);
        ...
        ruleElementTypeToPsiFactory.put(RESOLVETokenTypes.RULE_ELEMENT_TYPES.get(Resolve.RULE_mathSymbolRefExp), ResMathSymbolRefExpImpl.Factory.INSTANCE);
        ruleElementTypeToPsiFactory.put(RESOLVETokenTypes.RULE_ELEMENT_TYPES.get(Resolve.RULE_mathQualifierRefExp), ResMathSymbolRefExpImpl.Factory.INSTANCE);
