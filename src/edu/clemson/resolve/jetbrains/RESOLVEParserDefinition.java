...
public class RESOLVEParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet KEYWORDS = TokenSet.create(BY, CART_PROD, CHANGING, CONCEPT, CONSTRAINTS,
            CONVENTIONS, CORRESPONDENCE, CLASSIFICATION, CHAINABLE, DECREASING, DEFINITION, DO, ELSE, END, ENSURES, EXEMPLAR, EXISTS,
            EXTENSION, EXTERNALLY, FACILITY, FAMILY, FAMILY_TYPE, FOR, FORALL, FROM, IF, REALIZATION, REALIZED,
            INDUCTIVE, INITIALIZATION, IS, LAMBDA, MAINTAINING, MODELED, NOTICE, OPERATION, OF, OTHERWISE, PARAM_TYPE, PRECIS,
    ...
    public static final TokenSet OPERATORS = TokenSet.create(POUND, SYMBOL, MATH_SYMBOL, PRIME, COLON_EQUALS, EQUALS,
            LBRACK, RBRACK, LANGLE, RANGLE, LCUP, RCUP, LCEIL, RCEIL, DBL_BAR, BAR, COLON_EQUALS_COLON, IFF,
            TRUE, FALSE);
