...
public class RESOLVEParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet KEYWORDS = TokenSet.create(BASE, BY, CART_PROD, CHANGING, CONCEPT, CONSTRAINTS,
            ...
            EXTENSION, EXTERNALLY, FACILITY, FAMILY, FAMILY_TYPE, FOR, FORALL, FROM, HYPO, IF, IMPLEMENTATION, IMPLEMENTED,
    ...
    public static final TokenSet OPERATORS = TokenSet.create(AT, SYMBOL, MATH_SYMBOL, RESTRICTION_BAR, PRIME, COLON_EQUALS,
            COLON_EQUALS_COLON, IFF, TRUE, FALSE, QV);
