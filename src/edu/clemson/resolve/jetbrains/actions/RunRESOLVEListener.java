...
/** Listens for information coming back from the resolve compiler. Captures
 *  warnings, errors, and general informational printouts emitted by the
 *  compiler. This class, like {@link RunRESOLVEOnLanguageFile} follows very
 *  closely the tool listener written for this purpose in the ANTLRv4 plugin
 *  written by Terence Parr and others, found here:
 *
