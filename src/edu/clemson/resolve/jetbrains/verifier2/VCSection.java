...
public class VCSection extends JPanel {
	...
	public VerificationEditorPreview previewEditor; //the information about the vc
    ...
    public VCSection(SideBar owner, String name, VerificationEditorPreview preview) {
        this(owner, name, preview, State.PROCESSING);
    }

    //Starting constructor.
    public VCSection(SideBar owner, String name, VerificationEditorPreview preview, State activeState) {
