 ...
 * property to be usable by grammarkit (I guess).</p>
 */
public class ResPsiImplUtil {

    @NotNull
    public static TextRange getModuleSpecTextRange(
    ...
    @NotNull
    public static ResReference getReference(
            @NotNull ResReferenceExp o) {
        return new ResReference(o);
    }

    @NotNull
    public static ResMathVarLikeReference getReference(
            @NotNull ResMathReferenceExp o) {
    ...
    @Nullable
    public static ResType getResType(@NotNull final ResExp o,
    ...
    @Nullable
    public static ResType getResTypeInner(@NotNull final ResExp o,
                                          @Nullable ResolveState context) {
    ...
    @Nullable
    public static ResType getResTypeInner(@NotNull ResVarDef o,
                                          @Nullable ResolveState context) {
     ...
     */
    @Nullable
    public static ResMathExp getResMathMetaTypeExp(
