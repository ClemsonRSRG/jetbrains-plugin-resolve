...
/** Responsible for creating the actual {@link LookupElement}s for each
 *  keyword completed and inserting any completion based templates into the
 *  editor.
 *
 *  <p>
 *  Note that {@link #addCompletions(CompletionParameters, ProcessingContext, CompletionResultSet)}
 *  is the 'main' method here. This adds all completed elements for the
 *  keywords to the context box.</p>
 */
public class RESOLVEKeywordCompletionProvider
    ...
    public RESOLVEKeywordCompletionProvider(
            int priority, @Nullable AutoCompletionPolicy completionPolicy,
            @NotNull String... keywords) {
        this(priority, null, completionPolicy, keywords);
    }

    public RESOLVEKeywordCompletionProvider(
            int priority, @Nullable InsertHandler<LookupElement> insertHandler,
            @NotNull String... keywords) {
    ...
    public static LookupElement createKeywordLookupElement(
            @NotNull String keyword, int priority,
        ...
        return new InsertHandler<LookupElement>() {
            ...
            public void handleInsert(@NotNull InsertionContext context, LookupElement item) {
                ...
                if (template != null) {
                    ...
                    CharSequence documentText = editor.getDocument()
