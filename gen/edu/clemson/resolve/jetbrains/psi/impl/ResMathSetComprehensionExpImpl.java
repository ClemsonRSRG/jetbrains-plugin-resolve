...
public class ResMathSetComprehensionExpImpl extends ResMathExpImpl implements ResMathSetComprehensionExp {

  public ResMathSetComprehensionExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ResVisitor) ((ResVisitor)visitor).visitMathSetComprehensionExp(this);
