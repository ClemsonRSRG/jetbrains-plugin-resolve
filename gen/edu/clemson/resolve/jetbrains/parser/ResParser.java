...
public class ResParser implements PsiParser, LightPsiParser {
  ...
  public void parseLight(IElementType t, PsiBuilder b) {
    ...
    else if (t == MATH_CLSSFTNAL_ASSRT_EXP) {
      r = MathExp(b, 0, 3);
    }
    else if (t == MATH_EXP) {
      r = MathExp(b, 0, -1);
    ...
    else if (t == MATH_OUTFIX_APPLY_EXP) {
      r = MathOutfixApplyExp(b, 0);
    }
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(EXP, REFERENCE_EXP),
    ...
    create_token_set_(MATH_ALTERNATIVE_EXP, MATH_ALTERNATIVE_ITEM_EXP, MATH_ASSERTION_EXP, MATH_CLSSFTNAL_ASSRT_EXP,
      MATH_EXP, MATH_INFIX_APPLY_EXP, MATH_LAMBDA_EXP, MATH_NESTED_EXP,
  ...
  public static boolean ChangingClause(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, consumeToken(b, EXPARGUMENTLIST));
  ...
  public static boolean Exp(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, IDENTIFIER)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, EXP, null);
    r = NameExp(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean MathSymbolName(PsiBuilder b, int l) {
    ...
    r = MathSymbolName_0(b, l + 1);
    r = r && MathSymbolName_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // '@'?
  private static boolean MathSymbolName_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MathSymbolName_0")) return false;
    consumeToken(b, AT);
    return true;
  }
  ...
  /* ********************************************************** */
  // symbol|math_symbol
  static boolean MathSymbolNameNoId(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MathSymbolNameNoId")) return false;
    if (!nextTokenIs(b, "", MATH_SYMBOL, SYMBOL)) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  public static boolean SimpleStatement(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, IDENTIFIER)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _COLLAPSE_, SIMPLE_STATEMENT, null);
    r = Exp(b, l + 1);
    p = r; // pin = 1
  ...
  // 4: ATOM(MathSymbolExp) BINARY(MathSelectorExp) PREFIX(MathLambdaExp) ATOM(MathAlternativeExp) BINARY(MathClssftnalAssrtExp)
  ...
  public static boolean MathExp_0(PsiBuilder b, int l, int g) {
    ...
    while (true) {
      ...
      else if (g < 4 && MathClssftnalAssrtExp_0(b, l + 1)) {
        r = MathExp(b, l, 4);
        exit_section_(b, l, m, MATH_CLSSFTNAL_ASSRT_EXP, r, true, null);
      }
      else {
  ...
  public static boolean MathAlternativeExp(PsiBuilder b, int l) {
    ...
    r = r && MathAlternativesList(b, l + 1);
  ...
  // ':'|'⦂'
  private static boolean MathClssftnalAssrtExp_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MathClssftnalAssrtExp_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokenSmart(b, COLON);
    if (!r) r = consumeTokenSmart(b, HYPER_COLON);
    exit_section_(b, m, null, r);
    return r;
  }
