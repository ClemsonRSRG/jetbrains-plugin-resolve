...
public class ResParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(MATH_ALTERNATIVE_EXP, MATH_ALTERNATIVE_ITEM_EXP, MATH_ASSERTION_EXP, MATH_CART_PROD_EXP,
      ...
      MATH_LAMBDA_EXP, MATH_NESTED_EXP, MATH_NON_STD_APPLY_EXP, MATH_OUTFIX_APPLY_EXP,
      MATH_PREFIX_APPLY_EXP, MATH_QUANTIFIED_EXP, MATH_REFERENCE_EXP, MATH_SELECTOR_EXP,
      MATH_SET_RESTRICTION_EXP),
  };
  ...
  // 'realized' 'by' ModuleIdentifier ModuleArgList? [FromClause]
  public static boolean ExtensionPairing(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, consumeToken(b, REALIZED)) && r;
  ...
  // ('externally')? 'realized' 'by' ModuleIdentifier ModuleArgList? [FromClause]
  // ExtensionList? ';'
  ...
  public static boolean MathBracketName(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, MATH_BRACKET_SYMBOL)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, MATH_BRACKET_SYMBOL);
    exit_section_(b, m, MATH_SYMBOL_NAME, r);
    return r;
  }
  ...
  static boolean MathNonStdAppList(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, p, NonStdAppRec_parser_);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // ModuleIdentifier [FromClause] [asClause]
  ...
  public static boolean PrecisExtensionModuleDecl(PsiBuilder b, int l) {
    ...
    r = r && report_error_(b, consumeToken(b, FOR));
    r = p && report_error_(b, ReferenceExp(b, l + 1)) && r;
    r = p && report_error_(b, PrecisExtensionModuleDecl_4(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, SEMICOLON)) && r;
    r = p && report_error_(b, PrecisExtensionModuleDecl_6(b, l + 1)) && r;
  ...
  // ('with' ReferenceExp)?
  private static boolean PrecisExtensionModuleDecl_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "PrecisExtensionModuleDecl_4")) return false;
    PrecisExtensionModuleDecl_4_0(b, l + 1);
    return true;
  }

  // 'with' ReferenceExp
  private static boolean PrecisExtensionModuleDecl_4_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "PrecisExtensionModuleDecl_4_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // UsesList?
  private static boolean PrecisExtensionModuleDecl_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "PrecisExtensionModuleDecl_6")) return false;
    UsesList(b, l + 1);
    return true;
  }
  ...
  //    ATOM(MathAlternativeExp) BINARY(MathClssftnAssrtExp) ATOM(MathCartProdExp) PREFIX(MathSetRestrictionExp)
  ...
  public static boolean MathExp_0(PsiBuilder b, int l, int g) {
    ...
    while (true) {
      ...
      else if (g < 2 && MathNonStdApplyExp_0(b, l + 1)) {
        r = true;
        exit_section_(b, l, m, MATH_NON_STD_APPLY_EXP, r, true, null);
      }
  ...
  public static boolean MathOutfixApplyExp(PsiBuilder b, int l) {
    ...
    if (!nextTokenIsSmart(b, MATH_BRACKET_SYMBOL)) return false;
    boolean r, p;
  ...
  public static boolean MathLambdaExp(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _COLLAPSE_, MATH_LAMBDA_EXP, "<math lambda exp>");
  ...
  public static boolean MathSetRestrictionExp(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, null);
    r = MathSetRestrictionExp_0(b, l + 1);
    p = r;
    r = p && MathExp(b, l, -1);
    r = p && report_error_(b, consumeToken(b, RBRACE)) && r;
    exit_section_(b, l, m, MATH_SET_RESTRICTION_EXP, r, p, null);
    return r || p;
  }

  // '{' MathVarDecl '|'
  private static boolean MathSetRestrictionExp_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MathSetRestrictionExp_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  final static Parser NonStdAppRec_parser_ = new Parser() {
    public boolean parse(PsiBuilder b, int l) {
      return NonStdAppRec(b, l + 1);
    }
  };
